...
function validate_response(response_data: any) {
    ...
    expect(typeof (data.jsonrpc)).toBe('string')
    expect(typeof (data.result.transactions)).toBe('object')
    expect(typeof (data.result.number)).toBe('string')
    expect(typeof (data.result.hash)).toBe('string')
    expect(typeof (data.result.parentHash)).toBe('string')
    expect(typeof (data.result.sha3Uncles)).toBe('string')
    expect(typeof (data.result.logsBloom)).toBe('string')
    expect(typeof (data.result.transactionsRoot)).toBe('string')
    expect(typeof (data.result.stateRoot)).toBe('string')
    expect(typeof (data.result.receiptsRoot)).toBe('string')
    expect(typeof (data.result.miner)).toBe('string')
    expect(typeof (data.result.difficulty)).toBe('string')
    expect(typeof (data.result.totalDifficulty)).toBe('string')
    expect(typeof (data.result.extraData)).toBe('string')
    expect(typeof (data.result.size)).toBe('string')
    expect(typeof (data.result.gasLimit)).toBe('string')
    expect(typeof (data.result.gasUsed)).toBe('string')
    expect(typeof (data.result.timestamp)).toBe('string')
    expect(typeof (data.result.uncles)).toBe('object')
}
